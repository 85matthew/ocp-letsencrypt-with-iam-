...
echo "#### START OF 'aws.sh' SCRIPT"
HOME=/tmp
echo pwd=$(pwd)

export AWS_CONFIG_FILE=/home/letsencrypt/.aws/config
export AWS_SHARED_CREDENTIALS_FILE=/home/letsencrypt/.aws/credentials

export AWS_STS_ASSUME_ROLE_OUTPUT="$(/usr/local/bin/aws sts assume-role --role-arn $AWS_ROLE_ARN --role-session-name temprole)"
